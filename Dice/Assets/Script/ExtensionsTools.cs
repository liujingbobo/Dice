...
// {
//     [Label("基础"), LabelWidth(75)] public float basic;
//
//     [Label("线性(X*"), SuffixLabel(")", true), LabelWidth(75)]
//     public float liner;
//
//     [HorizontalGroup(Width = 100, GroupID = "Pow"), Label("指数(X+"), SuffixLabel(")", true), LabelWidth(45)]
//     public float phase;
//
//     [HorizontalGroup(Width = 100, GroupID = "Pow"), Label("^"), LabelWidth(10), GUIColor(1f, 0.5f, 0.5f)]
//     public float pow;
//
//     [HorizontalGroup(Width = 100, GroupID = "Pow"), Label("*"), LabelWidth(15)]
//     public float multi;
//
//     [HorizontalGroup(Width = 100, GroupID = "SelfPow"), Label("底数"), SuffixLabel("^X", true)
//      , LabelWidth(45), GUIColor(1f, 0.5f, 0.5f)]
//     public float selfPow;
//
//     [HorizontalGroup(Width = 100, GroupID = "SelfPow"), Label("*"), LabelWidth(15)]
...
//         new RecyclableList<GameObject>((o) => !o.GetCustomActive(), () =>
//         {
//             var child = Object.Instantiate(pattern, layout);
//             return child;
//         });
